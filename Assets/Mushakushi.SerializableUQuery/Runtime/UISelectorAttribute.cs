...
namespace Mushakushi.SerializableUQuery.Runtime
{
    ...
    public class UISelectorAttribute : PropertyAttribute
    {
        ...
        /// </remarks>
        public UISelectorAttribute(string selectorsContainerName, SelectorMode mode = SelectorMode.All, 
        ...
        /// <inheritdoc />
        public UISelectorAttribute(string selectorsContainerName, bool showEmptyPopup)
