...
namespace Mushakushi.SerializableUQuery.Editor
{
    [CustomPropertyDrawer(typeof(UISelectorAttribute))]
    public class UISelectorAttributeDrawer : PropertyDrawer
    {
        /// <summary>
        ...
        /// <summary>
        /// Base options for any fold out.
        /// </summary>
        private readonly string[] baseOptions = { "Select Any" };
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var uiSelectorAttribute = (UISelectorAttribute)attribute;
            ...
            var options = GetSelectors(selectorsContainerObject, uiSelectorAttribute.mode, baseOptions);
        ...
        /// </exception>
        /// <remarks>
        /// See documentation for <see cref="UISelectorAttribute"/> for valid types of containers. 
        /// </remarks>
